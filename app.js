const genres = [
  {
    ...
    items: [
      {
        ...
        titleTH: "มุโชคุ เท็นเซ ชีวิตใหม่ไม่หนีความจริง เกิดชาตินี้พี่ต้องเทพ มุโชคุเท็นเซ",
      ...
      {
         title: "Re:Zero",
        titleTH: "รีเซทชีวิต ฝ่าวิกฤตต่างโลก รีซีโร่ รีเซโร่ re zero",
    ...
    title: "Tensei Shitara Slime Datta Ken",
        titleTH: "โอนิแปลงร่าง ตำนานสไลม์ผู้ยิ่งใหญ่ สไลม์ เทนเซสไลม์ โอนิสไลม์",
    author: "Fuse",
    ...
    title: "The Rising of the Shield Hero",
        titleTH: "วีรบุรุษโล่ ผู้กอบกู้โลก ชิลด์ฮีโร่ โล่ฮีโร่ ไรซิ่งชิลด์ฮีโร่",
    author: "Aneko Yusagi",
    ...
    image: "isekai/The Rising of the Shield Hero.jpg"
      ...
      {
    title: "Konosuba",
        titleTH: "โคโนสุบะ ซ่าส์ปาร์ตี้ฝ่าต่างโลก โคโนสุบะ โนซุบะ",
    ...
    image: "isekai/Konosuba.jpg"
      ...
      {
    title: "Overlord",
        titleTH: "โอเวอร์ลอร์ด โอเวอร์ลอด overlord",
    ...
    title: "No Game No Life",
        titleTH: "โนเกม โนไลฟ์ โนเกมโนไลฟ์ no game no life",
    author: "Yuu Kamiya",
    ...
    title: "Isekai Oji-san",
        titleTH: "อิเซไก โอจิซัง คุณน้าต่างโลก คุณน้าอิเซไก โอจิซัง",
    ...
    image: "isekai/Isekai Oji-san.jpg"
     ...
     title: "Tondemo Skill de Isekai Hourou Meshi",
        titleTH: "ทักษะสุดแปลกในต่างโลก ร้านสะดวกซื้อในต่างโลก ทักษะแปลก",
    author: "Ren Eguchi",
    ...
    title: "Sword Art Online",
        titleTH: "ซอร์ดอาร์ตออนไลน์ ซอร์ดอาร์ต เอสเอโอ SAO",
  ...
  },
  {
    ...
    title: "Fullmetal Alchemist: Brotherhood",
        titleTH: "แขนกล คนแปรธาตุ แขนกล ฟูลเมทัลอัลเคมิสต์ ฟูลเมทัล fma",
    ...
    image: "Fantasy/Fullmetal Alchemist.jpg"
     ...
     {
    title: "Black Clover",
        titleTH: "แบล็กโคลเวอร์ จอมเวทอัศวินดำ แบล็กโคลเวอร์ โคลเวอร์ดำ",
    author: "Yuki Tabata",
    ...
    image: "Fantasy/Black Clover.jpg"
     ...
     {
    title: "Made in Abyss",
        titleTH: "เมดอินอะบิสส์ เมดอินอะบิส อะบิส",
    ...
    title: "Ranking of Kings",
        titleTH: "อันดับราชา แรงกิ้งออฟคิงส์ ราชาอันดับหนึ่ง",
    author: "Sosuke Toko",
    ...
    title: "Magi: The Labyrinth of Magic",
        titleTH: "มาจิ ราชันย์เวทมนตร์ มาจิ แมจิ",
    ...
    image: "Fantasy/Magi.jpg"
      ...
      {
    title: "Fairy Tail",
        titleTH: "แฟรี่เทล แฟรี่เทลล์ แฟรี่เทล",
    author: "Hiro Mashima",
    ...
    title: "Nanatsu no Taizai",
        titleTH: "นานัตสึ โนะ ไทไซ เจ็ดอาชญากรแห่งบาป เซเว่นเดดลี่ซินส์ เซเว่นเดดลี่ 7 deadly sins",
    ...
    title: "Natsume's Book of Friends",
        titleTH: "สมุดมิตรภาพของนัตสึเมะ นัตสึเมะ นัตสึเมะบุ๊คออฟเฟรนส์",
  ...
  },
  {
    ...
    title: "Jujutsu Kaisen",
        titleTH: "มหาเวทย์ผนึกมาร มหาเวทย์ จูจุสึไคเซ็น จูจุสึ",
    author: "Gege Akutami",
    ...
    title: "Demon Slayer: Kimetsu no Yaiba",
        titleTH: "ดาบพิฆาตอสูร ดาบพิฆาต ดีมอนสเลเยอร์ เดมอนสเลเยอร์",
    ...
    title: "Attack on Titan",
        titleTH: "ผ่าพิภพไททัน ผ่าพิภพ อแทคออนไททัน แอทแทคออนไททัน",
    ...
    title: "My Hero Academia",
        titleTH: "มายฮีโร่อคาเดเมีย มายฮีโร่ ฮีโร่อคาเดเมีย",
    ...
    image: "Action/My Hero Academia.jpg"
      ...
      {
    title: "Chainsaw Man",
        titleTH: "เชนซอว์แมน เชนซอ เชนซอว์ เชนโซว์แมน",
    ...
    image: "Action/Chainsaw Man.jpg"
      ...
      {
    title: "One Punch Man",
        titleTH: "วันพันช์แมน วันพั้นช์แมน วันพันชแมน",
    ...
    image: "Action/One Punch Man.jpg"
      ...
      {
    title: "Sakamoto Days",
        titleTH: "ซากาโมโตะเดส์ ซากาโมโตะ วันของซากาโมโตะ",
    author: "Yuto Suzuki",
    ...
    image: "Action/Sakamoto Days.jpg"
      ...
      {
    title: "Dandadan",
        titleTH: "แดนดาดัน ดันดาดัน dandadan",
    ...
    title: "Tokyo Revengers",
        titleTH: "โตเกียวรีเวนเจอร์ส โตเกียวรีเวนเจอร์ โตเกียว รีเวนเจอร์",
    author: "Ken Wakui",
  ...
  },
  {
    ...
    image: "Horror/jujutsu kaisen 2.jpg"
      ...
      {
    title: "Tokyo Ghoul",
        titleTH: "โตเกียวกูล โตเกียวกู โตเกียวกูร์",
    author: "Sui Ishida",
    ...
    image: "Horror/Tokyo Ghoul.jpg"
     ...
     {
    title: "Mieruko-chan",
        titleTH: "มิเอรุโกะจัง มิเอรุโกะ สาวน้อยเห็นผี",
    author: "Tomoki Izumi",
    ...
    title: "The Promised Neverland",
        titleTH: "แดนสัญญาเนเวอร์แลนด์ เนเวอร์แลนด์ โพรมิสเนเวอร์แลนด์",
    ...
    image: "Horror/The Promised Neverland.jpg"
      ...
      {
    title: "Hell Girl",
        titleTH: "เฮลเกิร์ล สาวนรก hell girl",
    ...
    image: "Horror/Hell Girl.jpg"
      ...
      title: "Jigoku Sensei Nube",
        titleTH: "ครูปราบผี ครูนูเบะ จิโกกุเซนเซนูเบะ",
      ...
      {
    title: "Death Note",
        titleTH: "เดธโน้ต เดทโน้ต เดทโนต เดธโนต",
    ...
    image: "Horror/Death Note.jpg"
      ...
      {
    title: "Jigoku Raku",
        titleTH: "นรกสวรรค์ จิโกกุรากุ hell paradise",
    author: "Yuji Kaku",
    ...
    title: "High School DxD",
        titleTH: "ไฮสคูล ดีเอ็กซ์ดี ดีเอ็กซ์ดี high school dxd",
  ...
  },
  {
    ...
    items: [
      {
    title: "Your Name",
        titleTH: "ชื่อของเธอ คิมิโนะนะวะ your name",
    ...
    image: "Romance/Your Name.jpg"
      ...
      {
    title: "Horimiya",
        titleTH: "โฮริมิยะ ฮอริมิยะ horimiya",
    ...
    title: "The Fragrant Flower Blooms With Dignity",
        titleTH: "ดอกไม้หอมผลิบาน ดอกไม้หอม คาโอรุฮานะ",
    author: "Saka Mikami",
    ...
    title: "Tonikaku Kawaii",
        titleTH: "โทนิคาคุ คาวาอิ น่ารักสุดๆ โทนิคาคุ tonikaku",
    author: "Kenjiro Hata",
    ...
    title: "Kubo-san wa Mob wo Yurusanai",
        titleTH: "คุโบะซัง ไม่ยอมให้ฉันหายไป คุโบะซัง kubo",
    ...
    title: "Insomniacs After School",
        titleTH: "นอนไม่หลับหลังเลิกเรียน นอนไม่หลับ อินซอมเนียก",
    author: "Makoto Ojiro",
    ...
    title: "Rent-A-Girlfriend",
        titleTH: "เช่าสาวมาเป็นแฟน เช่าแฟน เรนต์อะเกิร์ลเฟรนด์",
    ...
    title: "Rascal Does Not Dream of Bunny Girl Senpai",
        titleTH: "ฝันร้ายของกระต่ายสาว กระต่ายสาว บันนี่เกิร์ล บันนี่เซนไป",
    ...
    title: "Wotakoi: Love is Hard for Otaku",
        titleTH: "รักยากของสาวโอตาคุ โอตาคุรัก วอตาโกอิ",
    author: "Fujita",
    ...
    title: "Kokoro Connect",
        titleTH: "โคโคโระ คอนเนค โคโคโระคอนเนค",
  ...
  },
  {
    ...
    title: "Hunter x Hunter",
        titleTH: "ฮันเตอร์ x ฮันเตอร์ ฮันเตอร์ x ฮันเตอร์ ฮันเตอร์",
    ...
    image: "Adventure/Hunter x Hunter.jpg"
      ...
      {
    title: "Naruto",
        titleTH: "นารูโตะ นารูโต้ นารูโต",
    ...
    image: "Adventure/Naruto.jpg"
      ...
      {
    title: "Dragon Ball Z",
        titleTH: "ดราก้อนบอล แซด ดราก้อนบอล ดราก้อนบอลแซด",
    ...
    image: "Adventure/Dragon Ball Z.jpg"
      ...
      {
    title: "Vinland Saga",
        titleTH: "วินแลนด์ซาก้า วินแลนด์ vinland saga",
    ...
    image: "Adventure/Vinland Saga.jpg"
     ...
     {
  title: "Pokémon",
        titleTH: "โปเกมอน โปเกม่อน โปเก้มอน",
  ...
  image: "Adventure/Pokemon.jpg"
      ...
      {
    title: "Dr. Stone",
        titleTH: "ดร.สโตน ดอกเตอร์สโตน ดร สโตน",
    ...
    image: "Adventure/Dr. Stone.jpg"
      ...
      {
    title: "Tower of God",
        titleTH: "หอคอยแห่งพระเจ้า หอคอย ทาวเวอร์ออฟก็อด",
    author: "SIU",
    ...
    image: "Adventure/Tower of God.jpg"
      ...
      {
    title: "Danmachi",
        titleTH: "ดันมาชิ แดนมาชิ danmachi",
    author: "Fujino Omori",
...
genres.push({
  ...
  items: [
    {
      title: "Haikyuu",
        titleTH: "ไฮคิว วอลเลย์บอลหัวใจแชมป์ ไฮคิว ไฮค้ว วอลเล่ย์บอล",
    ...
    },
    {
      title: "Kuroko's Basketball",
        titleTH: "คุโรโกะ โนะ บาสเกต คุโรโกะ บาสเกต",
    ...
    {
      title: "Yuri on Ice",
        titleTH: "ยูริออนไอซ์ ยูริ yuri on ice",
    ...
    },
    {
      title: "Run with the Wind",
        titleTH: "วิ่งสู่ฝัน วิ่งกับสายลม run with the wind",
      author: "Shion Miura",
    ...
    {
      title: "Eyeshield 21",
        titleTH: "อายชิลด์ 21 อายชิลด์ eyeshield",
      author: "Riichiro Inagaki",
    ...
    {
      title: "Blue Lock",
        titleTH: "บลูล็อค บลูล็อก บลูล๊อค",
    ...
    },
    {
      title: "Inazuma Eleven",
        titleTH: "อินาสุมะอีเลฟเว่น อินาสุมะ inazuma eleven",
    ...
    },
    {
      title: "Hajime no Ippo",
        titleTH: "ฮาจิเมะ โนะ อิปโป้ ฮาจิเมะ อิปโป้ ชกเพื่อฝัน",
    ...
    {
      title: "Aoashi",
        titleTH: "อาโอะอาชิ อาโอะ aoashi",
    ...
    {
      title: "Initial D",
        titleTH: "อินิเชียล ดี initial d ซิ่งสายฟ้า",
...
let currentUID = null; // UID จาก Firebase
...
// โหลด favorites จาก Firestore
async function loadFavoritesForUser(uid) {
  return await loadFavoritesFromFirestore(uid);
}

// บันทึก favorites ไปยัง Firestore
async function saveFavoritesForUser(uid, favoritesSet) {
...
const recommendedItems = [ // เริ่มต้นประกาศตัวแปรอาเรย์เพื่อเก็บรายการอนิเมะแนะนำทั้งหมด
  { // เริ่มต้นเก็บข้อมูล Object ของอนิเมะเรื่องที่ 1
    ...
    title: "One Piece",
        titleTH: "วันพีซ วันพีช วันพีส", // ชื่อเรื่องอนิเมะ
  ...
  { // เริ่มต้นเก็บข้อมูล Object ของอนิเมะเรื่องที่ 2
    ...
    title: "Attack on Titan",
        titleTH: "ผ่าพิภพไททัน ผ่าพิภพ อแทคออนไททัน แอทแทคออนไททัน", // ชื่อเรื่องอนิเมะ
  ...
  { // เริ่มต้นเก็บข้อมูล Object ของอนิเมะเรื่องที่ 3
    ...
    title: "Dragon Ball Z",
        titleTH: "ดราก้อนบอล แซด ดราก้อนบอล ดราก้อนบอลแซด", // ชื่อเรื่องอนิเมะ
  ...
  { // เริ่มต้นเก็บข้อมูล Object ของอนิเมะเรื่องที่ 4
    ...
    title: "Demon Slayer (Kimetsu no Yaiba)",
        titleTH: "ดาบพิฆาตอสูร ดาบพิฆาต ดีมอนสเลเยอร์ เดมอนสเลเยอร์", // ชื่อเรื่องอนิเมะ
  ...
  { // เริ่มต้นเก็บข้อมูล Object ของอนิเมะเรื่องที่ 5
    ...
    title: "Jujutsu Kaisen",
        titleTH: "มหาเวทย์ผนึกมาร มหาเวทย์ จูจุสึไคเซ็น จูจุสึ", // ชื่อเรื่องอนิเมะ
...
function getFilteredItems() { // ฟังก์ชันสำหรับกรองข้อมูลอนิเมะตามการค้นหาหรือหมวดหมู่ที่เลือก
  ...
  if (currentSearch.trim() !== "") {
    ...
    // fuzzyMatch — คืนค่า score ยิ่งสูงยิ่งตรง
    function fuzzyScore(text, query) {
      ...
      // ทุกตัวอักษรของ query ปรากฏในลำดับที่ถูกต้องใน text (fuzzy)
      let ti = 0, qi = 0, score = 0;
      while (ti < text.length && qi < query.length) {
        if (text[ti] === query[qi]) { score++; qi++; }
        ti++;
      }
      if (qi === query.length) return Math.round((score / query.length) * 60);
      return 0;
    }
...
// (หมายเหตุ: โค้ดส่วนนี้ดูเหมือนจะยังไม่จบดี แต่อธิบายตามเท่าที่มีครับ)
  ...
  // ถ้าไม่มีการค้นหา ค่อยใช้ตัวกรองตามหมวดหมู่
...
// --- ระบบถูกใจ (Favorites) เชื่อมกับ Firebase ---
async function toggleFavorite(key) {
  ...
  await saveFavoritesForUser(currentUID, favorites);
  renderCards();
}
...
function openDetail(key) { // เริ่มการทำงานโดยรับค่าคีย์ (Key) ของอนิเมะที่ถูกคลิก
  ...
  if (item.characters && Array.isArray(item.characters) && item.characters.length > 0) {
    ...
    detailCharactersContainer.style.display = "none"; // ซ่อนถ้าไม่มีตัวละครหรือข้อมูลพัง
  }
...
if (forgotSubmit) {
  forgotSubmit.addEventListener("click", async () => {
    ...
    if (!email) {
      forgotMsg.textContent = "กรุณากรอกอีเมล";
      forgotMsg.className = "forgot-msg error";
      return;
    }
    forgotSubmit.textContent = "กำลังส่ง...";
    forgotSubmit.disabled = true;
    try {
      await firebaseResetPassword(email);
      forgotMsg.textContent = "✅ ส่งลิงก์รีเซ็ตรหัสผ่านไปที่อีเมลแล้ว กรุณาตรวจสอบกล่องจดหมาย";
      forgotMsg.className = "forgot-msg success";
      forgotEmail.value = "";
    } catch (e) {
      if (e.code === "auth/user-not-found" || e.code === "auth/invalid-email") {
        forgotMsg.textContent = "ไม่พบอีเมลนี้ในระบบ";
      } else {
        forgotMsg.textContent = "เกิดข้อผิดพลาด กรุณาลองใหม่";
      }
      forgotMsg.className = "forgot-msg error";
    } finally {
      forgotSubmit.textContent = "ส่งลิงก์รีเซ็ตรหัสผ่าน";
...
if (googleLoginBtn) {
  googleLoginBtn.addEventListener("click", async () => {
    try {
      ...
      loginError.textContent = "เข้าสู่ระบบด้วย Google ไม่สำเร็จ";
    }
  });
}

// Google Signup (ใช้ฟังก์ชันเดียวกัน)
...
if (googleSignupBtn) {
  googleSignupBtn.addEventListener("click", async () => {
    try {
      ...
      signupError.textContent = "สมัครด้วย Google ไม่สำเร็จ";
    }
  });
}
...
signupSubmit.addEventListener("click", async () => {
  ...
  if (!displayName || !email || !pass || !pass2) {
    signupError.textContent = "กรุณากรอกข้อมูลให้ครบถ้วน";
    return;
  }
  if (!email.includes("@")) {
    signupError.textContent = "รูปแบบอีเมลไม่ถูกต้อง";
    return;
  }
  if (pass.length < 6) {
  ...
  try {
    ...
    if (e.code === "auth/email-already-in-use") {
      signupError.textContent = "อีเมลนี้มีบัญชีอยู่แล้ว";
    } else if (e.code === "auth/admin-reserved") {
      signupError.textContent = "ชื่อนี้ถูกสงวนไว้ กรุณาใช้ชื่ออื่น";
